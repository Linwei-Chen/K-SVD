...
%https://ww2.mathworks.cn/help/matlab/ref/imread.html?searchHighlight=imread&s_tid=doc_srchtitle
[IMin0,pp]=imread(strcat([pathForImages,imageName]));

%im2double将图像调整为双精度值
%https://ww2.mathworks.cn/help/matlab/ref/im2double.html?searchHighlight=im2double&s_tid=doc_srchtitle
...
%https://ww2.mathworks.cn/help/matlab/ref/figure.html?searchHighlight=figure&s_tid=doc_srchtitle
figure;
